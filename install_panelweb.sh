...
echo -e "                \033[1;31mATENÇÃO"
echo ""
echo -e "\033[1;32mINFORME SEMPRE A MESMA SENHA TODA VEZ QUE SOLICITE"
echo -e "\033[1;32mSEMPRE CONFIRME AS PERGUNTAS COM  \033[1;37m Y"
echo ""
...
echo ""
echo -e "\033[1;32mSELECIONE \033[1;31mYES\033[1;32m NA SIGUIENTE OPÇÃO (\033[1;36mdbconfig-common\033[1;32m)"
echo -e "PARA CONFIGURAR A BASE DE DADOS"
echo ""
echo -e "\033[1;32mSEMPRE INTRODUZA A MESMA SENHA"
echo ""
echo -ne "\033[1;33mEnter, Para Continuar!\033[1;37m"; read
...
echo -e "\033[1;31mATENÇÃO \033[1;33m!!!"
echo ""
echo -ne "\033[1;32mINTRODUZA A MESMA SENHA\033[1;37m: "; read senha
...
if [[ -e "$HOME/plus.sql" ]]; then
    ...
    clear
    echo -e "\033[1;31mERRO AO IMPORTAR BASE DE DADOS\033[0m"
    sleep 2
    exit
fi
...
echo ""
echo -e "\033[1;36mLINK AREA DE ADMIN:\033[1;37m $IPadmin\033[0m"
echo -e "\033[1;36mLINK AREA DE REVENDEDOR: \033[1;37m $IP:\033[0m"
...
gestor_fun () {
echo -e "$barra"
echo -e " ${cor[3]} PAINEL DE VENDAS SSHPLUS ${cor[2]}[INSTALADOR]"
echo -e "$barra"
while true; do
echo -e "${cor[2]} [1] > ${cor[3]}SSHPLUS V10 VENDAS"
echo -e "${cor[2]} [2] > ${cor[3]}SSHPLUS V11 VENDAS"
echo -e "${cor[2]} [3] > ${cor[3]}ELIMINAR PAINEL SSHPLUS"
